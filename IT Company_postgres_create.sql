...
CREATE TABLE "public.member_responsiblity" (
	"tittle_id" serial NOT NULL,
	"tittle_name" varchar(255) NOT NULL,
	CONSTRAINT "member_responsiblity_pk" PRIMARY KEY ("tittle_id")
) WITH (
  OIDS=FALSE
);
...
ALTER TABLE "staff_members" ADD CONSTRAINT "staff_members_fk1" FOREIGN KEY ("tittle_id") REFERENCES "member_responsiblity"("tittle_id");
